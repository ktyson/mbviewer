...
// var yoffset = 0;
		...
		this.getPixelCoords = function(mbX,mbY) {
			...
			var scaleUp =  _zoom * _width;

console.log("w-z-sUp",_width, _zoom, scaleUp);
            
			var realX = (_xcorner + mbX - 2) * scaleUp;
			
            var realY = (_ycorner - mbY) * scaleUp; //_width/2; //(1.5-(mbY + 1.5)) * scaleUp; 

            
console.log("corners",_xcorner,_ycorner)
console.log("mb coords",mbX,mbY);
